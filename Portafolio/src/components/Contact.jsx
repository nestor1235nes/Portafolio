...
const Contact = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/nestor1235nes',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/nestor-ramirez-castro-b8393a350/',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: 'Email',
      url: 'mailto:ramireznestor99@hotmail.com',
      icon: (
  ...
  return (
    <section id="contact" className="contact">
      ...
      <footer className="footer">
        <p>© 2025 Néstor Ramírez. Hecho con React ⚛️</p>
      </footer>
    </section>
  );
};
